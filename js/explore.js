...
//Write a function that takes one parameter from the user
//This parameter should pass into the function as a string 
//Take each letter of the string 
//Change the places reversing them
//Print at the screen the new word
